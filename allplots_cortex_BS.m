...
% (C) 2018 Stefan Haufe, modified 2023 by Franziska Pellegrini
%
...
% subplot(2,3,4);
subplot(1,5,3);
showsurface3t(vc, cortex.Faces, surface_pars, data, varargin1{:});
...
%     h = subplot(2,3,3);
    ...
    set(h, 'clim', colorlimits, 'visible', 'off', 'position', [0.2 0.42 0.6 0.2]) %, 'position', [0.1 0.1 0.6 0.8]); 
    set(hf, 'visible', 'off')
    cb = colorbar;
    set(cb, 'fontsize', 14)
